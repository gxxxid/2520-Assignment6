...
def get_screen_speed():
    ...
    speed = input("Enter screen speed (fast/slow/normal): ")
    if speed.lower() == "fast":
        return 120  # Fast speed = 120 frames per second
    elif speed.lower() == "slow":
        return 30  # Slow speed = 30 frames per second
    else:
        return 60  # Normal speed = 60 frames per second (default)
...
def check_lights_and_day():
    are_lights_on = input("Do you want the lights on? ")
    is_day = input("Do you want it to be day? ")

    if is_day.lower() == "yes" or is_day.lower() == "y" :
        day = True
    else:
        day = False

    if are_lights_on.lower() == "yes" or are_lights_on.lower() == "y":
        lights = True
    else:
        lights = False
...
def generate_stars_and_clouds():
    ...
    if stars_input == "little":
        num_stars = 50
    elif stars_input == "middle":
        num_stars = 100
    elif stars_input == "alot":
        num_stars = 500
    else:
        print("Invalid input. Defaulting to 200 stars.")
        num_stars = 200

    if clouds_input == "little":
        num_clouds = 5
    elif clouds_input == "middle":
        num_clouds = 100
    elif clouds_input == "alot":
        num_clouds = 200
    else:
        print("Invalid input. Defaulting to 20 clouds.")
        num_clouds = 20
